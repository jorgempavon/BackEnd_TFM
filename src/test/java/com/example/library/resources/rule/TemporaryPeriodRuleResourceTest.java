...
public class TemporaryPeriodRuleResourceTest {
    @Mock
    private TemporaryPeriodRuleService temporaryPeriodRuleService;
    @Mock
    private CustomUserDetails mockUserDetails;
    @InjectMocks
    private TemporaryPeriodRuleResource temporaryPeriodRuleResource;
    ...
    void createTemporaryPeriodRule_successful() {
        ...
        ResponseEntity<?> result = temporaryPeriodRuleResource.create(mockUserDetails,RULE_CREATE_DTO);
